...
namespace PathFinder.Button
{
    ...
    public class button
    {
        ...
        public virtual void draw(int appid)
        {
            vars.spriteBatch.Draw(Unit2D.getTexture(appid, game) /*ShaderResourceView.FromFile(device, "accel_world_007.jpg")*/, pos, Color.Beige);
        }
